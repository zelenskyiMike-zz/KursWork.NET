...
namespace Kurs_work_AFH.Login_DBDataSetTableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Login] SET [Username] = @Username, [Password] = @Password, [Role] = @Role WHERE (([Username] = @Original_Username) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Role = 1 AND [Role] IS NULL) OR ([Role] = @Original_Role)));
SELECT Username, Password, Role FROM Login WHERE (Username = @Username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Kurs_work_AFH.Properties.Settings.Default.Login_DBConnectionString;
        }
        ...
        public virtual int Fill(Login_DBDataSet.LoginDataTable dataTable) {
        ...
        public virtual Login_DBDataSet.LoginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Login_DBDataSet.LoginDataTable dataTable = new Login_DBDataSet.LoginDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Login_DBDataSet.LoginDataTable dataTable) {
